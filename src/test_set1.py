...
class TestSetOne(unittest.TestCase):
    ...
    def test_should_return_none_if_strings_do_not_have_same_length(self):
        string1 = "1c011100"
        string2 = "686974207468652"
        self.assertEqual(challenge2.xor_strings(string1, string2), None)
